    ...
    <div className="flex min-h-screen bg-slate-50">
      ...
      <main className="flex-1 p-8 ml-64 min-h-screen">
        ...
        <header className="flex items-center justify-between mb-8">
          <div>
            <h2 className="text-3xl font-black text-slate-900">Treatments</h2>
            <p className="text-slate-500 mt-1">Manage and document clinical treatments and diagnostics</p>
          </div>
        ...
        <div className="bg-white rounded-3xl border border-slate-100 shadow-sm p-12 text-center max-w-3xl">
          <Stethoscope className="mx-auto text-slate-350 mb-4" size={48} />
          <h3 className="text-xl font-bold text-slate-900 mb-1">Treatments Section</h3>
